...
<div class="register-box">
    ...
    <div class="card">
        <div class="card-body register-card-body">
            ...
            <form action="{{route('frontend.handle-register')}}" method="post">
                @csrf
                <div class="input-group mb-3">
                    <input type="text" class="form-control" placeholder="Họ và tên " name="fullname" value="{{$errors->has('fullname') ? false : old('fullname')}}">
                ...
                @enderror
                <div class="input-group mb-3">
                    <input type="text" class="form-control" placeholder="Tên đăng nhập " name="username" value="{{$errors->has('username') ? false : old('username')}}">
                    <div class="input-group-append">
                        <div class="input-group-text">
                            <span class="fas fa-user"></span>
                        </div>
                ...
                <div class="input-group mb-3">
                    <input type="email" class="form-control" placeholder="Email" value="{{$errors->has('email') ? false : old('email')}}" name="email">
                    <div class="input-group-append">
                        <div class="input-group-text">
